  ...
  // Uttarakhand
  {
    ...
    details: {
      ...
      placeImages: [
        "https://example.com/corbett1.jpg",
        "https://example.com/corbett2.jpg",
        "https://example.com/corbett3.jpg",
        "https://example.com/corbett4.jpg"
      ],
  ...
  // Madhya Pradesh
  {
    ...
    details: {
      ...
      placeImages: [
        "https://example.com/kanha1.jpg",
        "https://example.com/kanha2.jpg",
        "https://example.com/kanha3.jpg",
        "https://example.com/kanha4.jpg"
      ],
      ...
      reviews: "1800+",
      established: "1955",
      tags: ["Wildlife", "Tiger Reserve", "Nature"]
    }
  },
  // Mumbai
  {
    ...
    details: {
      ...
      placeImages: [
        "https://example.com/juhu-beach1.jpg",
        "https://example.com/juhu-beach2.jpg",
        "https://example.com/juhu-beach3.jpg",
        "https://example.com/juhu-beach4.jpg"
      ],
  ...
  // Bangalore
  {
    ...
    details: {
      ...
      placeImages: [
        "https://example.com/state-library1.jpg",
        "https://example.com/state-library2.jpg",
        "https://example.com/state-library3.jpg",
        "https://example.com/state-library4.jpg"
      ],
...
// Updated openPlacePage function to use placeImages and the same carousel as stores
function openPlacePage(placeName) {
  ...
  placePage.innerHTML = `
    ...
    <div class="place-content">
      <!-- Hero Section with Place Image Carousel -->
      <div class="place-hero">
        <div class="place-image-carousel">
          ${place.details.placeImages.map((image, index) => `
            <div class="place-carousel-item ${index === 0 ? 'active' : ''}">
              <img src="${image}" alt="${place.details.name}" class="place-image" onclick="openFullScreen('${image}')">
            </div>
          `).join('')}
